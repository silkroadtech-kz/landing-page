(function () {
	...
	var translations = {
		...
		"lpg.cta.audit": { ru: "Получить бесплатный аудит", en: "Get a free audit" },
		"lpg.cta.wa": { ru: "WhatsApp", en: "WhatsApp" },
		"lpg.badge": { ru: "Под ключ · 7 дней — от 250 000 ₸", en: "Turnkey · 7 days — from 250,000 ₸" },
		"lpg.inc.title": { ru: "Что входит", en: "What's included" },
		"lpg.inc.1": { ru: "Структура и тексты под конверсию", en: "Conversion-focused structure and copy" },
		"lpg.inc.2": { ru: "Адаптивный дизайн под все устройства", en: "Responsive design for every device" },
		"lpg.inc.3": { ru: "Форма заявки → Telegram и почта", en: "Lead form → Telegram and email" },
		"lpg.inc.4": { ru: "Домен и корпоративная почта", en: "Domain and corporate email" },
		"lpg.inc.5": { ru: "Аналитика: Метрика и Google Analytics", en: "Analytics: Metrica and Google Analytics" },
		"lpg.inc.6": { ru: "SEO + GEO — Google, Яндекс, AI-поиск", en: "SEO + GEO — Google, Yandex, AI search" },
		"lpg.proc.eyebrow": { ru: "Как всё пройдёт", en: "How it goes" },
		"lpg.proc.title": { ru: "От заявки до запуска — 7 дней", en: "From request to launch — 7 days" },
		"lpg.proc.1.t": { ru: "Бриф", en: "Brief" },
		"lpg.proc.1.d": { ru: "Звонок 30 минут: что вы делаете, кто покупает, какие цели.", en: "A 30-minute call: what you do, who buys, what the goals are." },
		"lpg.proc.1.day": { ru: "День 1", en: "Day 1" },
		"lpg.proc.2.t": { ru: "Макет", en: "Mockup" },
		"lpg.proc.2.d": { ru: "Показываем дизайн и структуру. Согласуем тексты и блоки.", en: "We show design and structure. We agree on copy and blocks." },
		"lpg.proc.2.day": { ru: "Дни 2–4", en: "Days 2–4" },
		"lpg.proc.3.t": { ru: "Запуск", en: "Launch" },
		"lpg.proc.3.d": { ru: "Подключаем домен, почту, формы и аналитику. Сайт в сети — дальше поддержка.", en: "We connect domain, email, forms, and analytics. Site is live — then support." },
		"lpg.proc.3.day": { ru: "Дни 5–7", en: "Days 5–7" },
		"lpg.port.eyebrow": { ru: "Нам доверяют", en: "Trusted by" },
		"lpg.port.title": { ru: "Мы уже сделали это", en: "We've already done this" },
		...
		"lpg.faq.q1": { ru: "Сколько стоит разработка лендинга или сайта?", en: "How much does a landing page or site cost?" },
		"lpg.faq.a1": { ru: "Сайт под ключ — от 250 000 ₸. Точную цену назовём после короткого бесплатного аудита.", en: "A turnkey site starts from 250,000 ₸. We'll give an exact quote after a short free audit." },
		"lpg.faq.q2": { ru: "А если у меня уже есть сайт?", en: "What if I already have a site?" },
		"lpg.faq.a2": { ru: "Посмотрим текущий и честно скажем: обновить или сделать заново. Часто новый сайт быстрее и дешевле.", en: "We'll review the current one and tell you honestly: update or rebuild. Often a new site is faster and cheaper." },
		"lpg.faq.q3": { ru: "Как быстро вы запустите?", en: "How fast can you launch?" },
		...
		"lpg.req.b1": { ru: "› Ответ в течение рабочего дня", en: "› Reply within one business day" },
		"lpg.req.b2": { ru: "› Первая консультация — бесплатно", en: "› First consultation is free" },
		"lpg.req.b3": { ru: "› Резидент Astana Hub · 40+ проектов", en: "› Astana Hub resident · 40+ projects" },
