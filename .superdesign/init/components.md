...
This project is a static multi-page marketing site with no standalone shared component files. Reusable UI is embedded directly inside the HTML pages.

## Shared Primitive Patterns

- Navigation bar: inlined in `index.html`, `about.html`, `cases.html`
- Footer: inlined in `index.html`, `about.html`, `cases.html`
- Theme toggle behavior: shared through `assets/theme.js`
- Dark theme overrides: shared through `assets/theme.css`
